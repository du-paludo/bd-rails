...
#       post produtos_url, params: { produto: { estoque: @produto.estoque, nome: @produto.nome, preco: @produto.preco } }
#     end
...
#     patch produto_url(@produto), params: { produto: { estoque: @produto.estoque, nome: @produto.nome, preco: @produto.preco } }
