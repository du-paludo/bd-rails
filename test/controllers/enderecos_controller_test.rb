...
#       post enderecos_url, params: { endereco: { cep: @endereco.cep, cliente_id: @endereco.cliente_id, logradouro: @endereco.logradouro } }
#     end
...
#     patch endereco_url(@endereco), params: { endereco: { cep: @endereco.cep, cliente_id: @endereco.cliente_id, logradouro: @endereco.logradouro } }
